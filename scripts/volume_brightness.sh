...
function get_brightness {
    brightnessctl get | awk '{print int($1/255*100)}'  # or: light -G
}
...
case $1 in
    ...
    brightnessctl set +$brightness_step%  # or: light -A $brightness_step
    show_brightness_notif
    ;;

    brightness_down)
    # Decreases brightness and displays the notification
    brightnessctl set $brightness_step%-  # or: light -U $brightness_step
    show_brightness_notif
    ;;
esac
